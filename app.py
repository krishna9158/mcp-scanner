...
def index():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            report, warning, secrets = future.result(timeout=SCAN_TIMEOUT_SECONDS)
    ...
    return render_template_string(PAGE, report=report, error=error, warning=warning, secrets=secrets)
